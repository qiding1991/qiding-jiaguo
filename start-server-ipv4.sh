...
nohup java  -Djava.net.preferIPv4Stack=true -Djava.net.preferIPv4Addresses=true -jar qiding-jiaguo-news/target/qiding-jiaguo-news-0.0.1-SNAPSHOT.jar > log/qiding-jiaguo-news.log &
